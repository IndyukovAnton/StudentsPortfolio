import "../../assets/css/components/project/projectList.css";
import type { Project } from "./projectItem";
import {ProjectItem } from "./projectItem";

export default function ProjectList(props: {lessons: any}) {
	...
	return (
		<section className="projects">
			{
				lessonsKeys.map((key, lessonIndex) => {
			  const projects: [] = lessons[key];

					return projects.map((project: Project, projectIndex)=> {
						return <ProjectItem key={"Lesson_"+ lessonIndex + "Project_" + projectIndex} author={project.author} comment={project.comment} photoURL={project.photoURL} link={project.link} tags={project.tags}></ProjectItem>
					})
				})
			}
